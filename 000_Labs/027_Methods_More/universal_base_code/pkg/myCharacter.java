...
public class myCharacter {
	...
	public myCharacter(String inputRole) {
		...
		public static int setStrength(int inputStrength){
			int strength = inputStrength;
			if(inputStrength <= 10){
				System.out.print("You have "+strength+" skill points");
			}
			return strength;
		}
		public static int setDexterity(int inputDexterity){
			int dexterity = inputDexterity;
			if(inputDexterity <= 10){
				System.out.println("You have "+dexterity+" skill points");
			}
			return dexterity;
		}
}
